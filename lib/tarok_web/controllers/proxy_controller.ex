defmodule TarokWeb.ProxyController do
  ...
  defp add_response_header(conn, [{"Content-Security-Policy", _} | rest]), do: add_response_header(conn, rest)
  defp add_response_header(conn, [{"Strict-Transport-Security", _} | rest]), do: add_response_header(conn, rest)
